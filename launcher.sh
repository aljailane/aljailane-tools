...
# الإصدار: 2.3 (واجهة اختيار لغة نظيفة)
...
# --- المسارات إلى السكربتات الفرعية ---
SCANNER_SCRIPT="./sec.sh"
ANALYTICS_SCRIPT="./an.sh"
...
load_texts() {
    ...
    TEXTS[ar_about_version]="الإصدار: 2.3"
    ...
    TEXTS[en_about_version]="Version: 2.3"
